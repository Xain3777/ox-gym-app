...
export const MACHINES: Machine[] = [
  ...
  // ── CHEST ───────────────────────────────────────────────────
  {
    id: "11",
    model: "MND-FH07",
    name: "Pec / Rear Delt Fly",
    nameAr: "فلاي صدر/خلفي",
  ...
  // ── SHOULDERS ───────────────────────────────────────────────
  {
    id: "17",
    model: "MND-FH20",
    name: "Split Shoulder Press",
    nameAr: "ضغط كتف منفصل",
  ...
  // ── BACK ─────────────────────────────────────────────────────
  {
    id: "27",
    model: "MND-FH89B",
    name: "Pulldown / Long Row",
    nameAr: "سحب علوي/طويل",
