...
const OFFERS = [
  ...
  { id: 2, label_ar: "عرض الأزواج",       code: "couple",    effect_ar: "شخصين بـ ٦٠$ بدل ٧٠$",          note_ar: "خطة الشهر فقط" },
  { id: 3, label_ar: "شركات / بنك",       code: "corporate", effect_ar: "خصم ١٥٪",                       note_ar: "موظفي الشركات والبنوك — على الاشتراك الشهري" },
  { id: 4, label_ar: "طلاب الجامعة",      code: "college",   effect_ar: "خصم ٢٠٪",                       note_ar: "طلاب الجامعات — على الاشتراك الشهري" },
  { id: 5, label_ar: "جيران البناء",      code: "neighbors", effect_ar: "خصم ٢٠٪",                       note_ar: "سكان البناء المجاور" },
  { id: 6, label_ar: "مجموعة ٥ أشخاص",   code: "group_5",   effect_ar: "ادفعوا سعر ٤ أشخاص فقط",        note_ar: "٥ أشخاص يدفعون سعر ٤ — بنفس group_id" },
  { id: 7, label_ar: "مجموعة ٩ أشخاص",   code: "group_9",   effect_ar: "ادفعوا سعر ٧ أشخاص فقط",        note_ar: "٩ أشخاص يدفعون سعر ٧ — بنفس group_id" },
];
...
const RULES = [
  ...
  "مجموعة ٥ أشخاص: ادفعوا سعر ٤ أشخاص فقط (السعر للفرد = الأساس × ٤/٥).",
  "مجموعة ٩ أشخاص: ادفعوا سعر ٧ أشخاص فقط (السعر للفرد = الأساس × ٧/٩).",
  "عروض المجموعات تنطبق على خطة الشهر فقط.",
