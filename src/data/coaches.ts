...
export const COACHES_AR: readonly CoachAr[] = [
  {
    ...
    title: "الهيد كوتش",
    role: "head_coach",
    specialty: ["بناء أجسام"],
    experience: "١٢ سنة في التدريب الرياضي",
    education: "ماجستير في الحقوق",
    achievements: [
      "دبلوم تدريب رياضي معتمد من معهد Alison",
      "بطل الجمهورية في فئة الفيزيك (Men's Physique)",
    ],
  ...
  },
  {
    ...
    title: "الكوتش",
    role: "coach",
    specialty: ["أيروبيك", "بناء أجسام"],
    experience: "٧ سنوات",
    education: "أدب انكليزي",
    achievements: ["شهادة مدرب من الاتحاد الرياضي — درجة ثانية"],
  ...
  },
  {
    ...
    title: "الكوتش",
    role: "coach",
    specialty: ["بناء أجسام", "كاليسثنكس"],
    experience: "٦ سنوات",
  ...
  },
  {
    ...
    title: "الكوتش",
    role: "coach",
    specialty: ["كاليسثنكس", "بناء أجسام"],
    experience: "٧ سنوات",
